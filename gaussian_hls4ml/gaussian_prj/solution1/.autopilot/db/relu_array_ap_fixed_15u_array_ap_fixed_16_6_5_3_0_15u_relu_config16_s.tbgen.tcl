set moduleName relu_array_ap_fixed_15u_array_ap_fixed_16_6_5_3_0_15u_relu_config16_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,15u>,array<ap_fixed<16,6,5,3,0>,15u>,relu_config16>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer15_out int 555 regular {fifo 0 volatile }  }
	{ layer16_out int 240 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer15_out", "interface" : "fifo", "bitwidth" : 555, "direction" : "READONLY"} , 
 	{ "Name" : "layer16_out", "interface" : "fifo", "bitwidth" : 240, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer15_out_dout sc_in sc_lv 555 signal 0 } 
	...
	{ layer16_out_din sc_out sc_lv 240 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer15_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":555, "type": "signal", "bundle":{"name": "layer15_out", "role": "dout" }} , 
 	...
 	{ "name": "layer16_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":240, "type": "signal", "bundle":{"name": "layer16_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "relu_array_ap_fixed_15u_array_ap_fixed_16_6_5_3_0_15u_relu_config16_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	relu_array_ap_fixed_15u_array_ap_fixed_16_6_5_3_0_15u_relu_config16_s {
...
set Spec2ImplPortList { 
	layer15_out { ap_fifo {  { layer15_out_dout fifo_data_in 0 555 }  { layer15_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer15_out_fifo_cap fifo_update 0 2 }  { layer15_out_empty_n fifo_status 0 1 }  { layer15_out_read fifo_port_we 1 1 } } }
	layer16_out { ap_fifo {  { layer16_out_din fifo_data_in 1 240 }  { layer16_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer16_out_fifo_cap fifo_update 0 2 }  { layer16_out_full_n fifo_status 0 1 }  { layer16_out_write fifo_port_we 1 1 } } }
}
