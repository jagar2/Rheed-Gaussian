set moduleName thresholded_relu_array_ap_fixed_array_ap_fixed_6u_thresholdedrelu_config4_s
set isTopModule 0
...
set C_modelName {thresholded_relu<array,ap_fixed,array<ap_fixed,6u>,thresholdedrelu_config4>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer2_out int 222 regular {fifo 0 volatile }  }
	{ layer4_out int 96 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 222, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 222 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":222, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "thresholded_relu_array_ap_fixed_array_ap_fixed_6u_thresholdedrelu_config4_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	thresholded_relu_array_ap_fixed_array_ap_fixed_6u_thresholdedrelu_config4_s {
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data_in 0 222 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 13 }  { layer2_out_fifo_cap fifo_update 0 13 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_port_we 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_data_in 1 96 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 13 }  { layer4_out_fifo_cap fifo_update 0 13 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_port_we 1 1 } } }
}
