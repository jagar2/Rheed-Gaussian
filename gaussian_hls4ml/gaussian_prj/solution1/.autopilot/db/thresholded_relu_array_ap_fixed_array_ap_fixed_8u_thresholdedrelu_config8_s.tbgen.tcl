set moduleName thresholded_relu_array_ap_fixed_array_ap_fixed_8u_thresholdedrelu_config8_s
set isTopModule 0
...
set C_modelName {thresholded_relu<array,ap_fixed,array<ap_fixed,8u>,thresholdedrelu_config8>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer6_out int 312 regular {fifo 0 volatile }  }
	{ layer8_out int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 312, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer6_out_dout sc_in sc_lv 312 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer6_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":312, "type": "signal", "bundle":{"name": "layer6_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "thresholded_relu_array_ap_fixed_array_ap_fixed_8u_thresholdedrelu_config8_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	thresholded_relu_array_ap_fixed_array_ap_fixed_8u_thresholdedrelu_config8_s {
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_in 0 312 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer6_out_fifo_cap fifo_update 0 8 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_port_we 1 1 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_in 1 128 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer8_out_fifo_cap fifo_update 0 8 }  { layer8_out_full_n fifo_status 0 1 }  { layer8_out_write fifo_port_we 1 1 } } }
}
